package lesson6.step3;

import lesson6.step1.Status;

import java.util.Arrays;
import java.util.Scanner;

import static lesson6.step1.Status.ERROR;
import static lesson6.step1.Status.SUCCESS;
import static lesson6.step3.Operation.*;
